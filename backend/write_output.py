...
def writeOutputs(filePath, outputPath, foci, zone, lat, long, year):
    ...
    foci_df.to_file(os.path.join(outputPath, f'foci_{year}.shp'))
    zones.to_file(os.path.join(outputPath, f'zones_{year}.shp'))
